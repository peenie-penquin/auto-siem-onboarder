...
namespace test_auth.Controllers
{
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Name,Division")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Email,Name,Division")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
